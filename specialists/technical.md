...
The wiki root (`wiki/README.md`) is orchestrator-generated and out of
...
The wiki **root** overview (`wiki/README.md`) is separate and out of scope for
technical writers — it is the orchestrator-generated table of contents.
...
- Writers produce files **only under an enabled track folder** (`wiki/TECHNICAL/`
  ...
  (`wiki/README.md`) — it is orchestrator-generated and out of scope.
