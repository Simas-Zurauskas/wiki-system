...
The wiki **root** overview (`wiki/README.md`) is separate, orchestrator-generated, and
...
- Writers produce files **only under `wiki/PRODUCT/`**. Never create
  or modify files at the wiki root (`wiki/README.md`). That is
  orchestrator-generated and out of scope.
